...
const ListaProductos = () => {
    ...
    //Calcular los totales basandonos en la lista actual
    const totalProductos = productosOrdenados.length;

    const valorTotalInventario = productosOrdenados.reduce((acc,p) =>
        acc + (p.precio * p.stock), 0
    );

    const totalStock = productosOrdenados.reduce((acc,p) => 
        acc + p.stock, 0
    );
                ...
                <div className='col-md-4'>
                    <div className='card border-left-success shadow h-100 py-2'>
                        <div className='card-body'>
                            ...
                            <div className='h5 mb-0 font-weight-bold text-gray-800'>{valorTotalInventario.toLocaleString()}</div>
                        </div>
                    </div>
                </div>
                <div className='col-md-4'>
                    <div className='card border-left-info shadow h-100 py-2'>
                        <div className='card-body'>
                            ...
                            <div className='h5 mb-0 font-weight-bold text-gray-800'>{totalStock} unidades</div>
                        </div>
                    </div>
                </div>
            </div>
